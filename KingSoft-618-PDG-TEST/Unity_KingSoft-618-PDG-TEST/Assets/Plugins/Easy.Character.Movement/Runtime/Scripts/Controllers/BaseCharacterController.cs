...
namespace ECM.Controllers
{
    ...
    public class BaseCharacterController : MonoBehaviour
    {
        ...
        protected virtual void HandleInput()
        {
            ...
            Vector3 cameraEuler = trans.eulerAngles;
#if UNITY_EDITOR
            ...
            moveDirection = new Vector3
            {
                x = FixedJoystick.instance.Horizontal,
                y = 0.0f,
                z = FixedJoystick.instance.Vertical
            };
#endif
            ...
            if (Input.GetMouseButton(1)) {
                moveDirection = Quaternion.Euler(0, lastY, 0) * moveDirection;
            }
            else {
                moveDirection = Quaternion.Euler(0, cameraEuler.y, 0) * moveDirection;
            }
